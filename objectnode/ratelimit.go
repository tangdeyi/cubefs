...
func (r *UserRateMgr) QPSLimitAllowed(uid string) (bool, time.Duration) {
	...
	defaultQPSLimit := r.UserLimitConf.QPSQuota[DefaultUid]
...
func (r *UserRateMgr) ConcurrentLimitAcquire(uid string) error {
	...
	defaultConcurrentLimit := r.UserLimitConf.ConcurrentQuota[DefaultUid]
...
func (r *UserRateMgr) LimitRelease(uid string) {
	r.ConcurrentLimit.Release(uid)
}

func (r *UserRateMgr) GetResponseWriter(uid string, w io.Writer) io.Writer {

	defaultBandWidthLimit := r.UserLimitConf.BandWidthQuota[DefaultUid]
